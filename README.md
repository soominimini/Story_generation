...
## Features
- **User Management System:** Multi-user support with individual profiles, authentication, and user-specific chat history. Each user gets their own directory for managing conversations and preferences.
...
The QTrobot AI Assistant now includes a user management system that allows multiple users to register and maintain their own chat history. When you start the application, you'll be prompted to login or register.

**First-time users:**
1. Start the application: `python src/qt_ai_data_assistant.py`
2. Choose option 2 (Register) to create a new account
3. Enter your username, age, and optionally a password
4. Login with your credentials
5. Your chat history will be automatically saved and restored for future sessions

**Returning users:**
1. Start the application: `python src/qt_ai_data_assistant.py`
2. Choose option 1 (Login) and enter your credentials
3. Your previous chat history will be automatically loaded

For detailed information about the user management system, see [USER_MANAGEMENT_README.md](USER_MANAGEMENT_README.md).
